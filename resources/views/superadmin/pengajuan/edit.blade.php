...
@endif
    <form action="{{ route('superadmin.pengajuan.update', $pengajuan['id_pengajuan']) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="card">
            <div class="card-body">
                    ...
                    <select name="id_mahasiswa"
                        ...
                        @foreach($mahasiswa as $mhs)
                            @php
                                ...
                                $prodiName = data_get($mhs, 'superadmin.nama_prodi');
                ...
                <a href="{{ route('superadmin.pengajuan.index') }}" class="btn btn-secondary">Batal</a>
            </div>
        </div>
    </form>
@stop

...
@section('content')
    <div class="mb-3">
        <a href="{{ route('superadmin.sertifikasi.create') }}" class="btn btn-primary">
                ...
                <tbody>
                    @forelse ($rows as $index => $sertifikasi)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('superadmin.sertifikasi.edit', $sertifikasi['id_sertifikasi']) }}" class="btn btn-warning btn-sm">Edit</a>
                                <form action="{{ route('superadmin.sertifikasi.destroy', $sertifikasi['id_sertifikasi']) }}"

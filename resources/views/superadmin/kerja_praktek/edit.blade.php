...
@stop
@section('content')
    <form action="{{ route('superadmin.kerja_praktek.update', $kerja_praktek['id_kerja_praktek']) }}?_method=PUT" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('superadmin.kerja_praktek.index') }}" class="btn btn-secondary">Kembali</a>
            </div>
        </div>
    </form>
@stop

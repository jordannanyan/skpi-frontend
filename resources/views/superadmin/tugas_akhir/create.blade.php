...
@stop
@section('content')
    <form action="{{ route('superadmin.tugas_akhir.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('superadmin.tugas_akhir.index') }}" class="btn btn-secondary">Kembali</a>
            </div>
        </div>
    </form>
@stop

...
@section('content')
    <div class="mb-3">
        <a href="{{ route('mahasiswa.prodi.create') }}" class="btn btn-primary">
                ...
                <tbody>
                    @forelse($data as $prodi)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('mahasiswa.prodi.edit', $prodi['id_prodi']) }}" class="btn btn-sm btn-warning">Edit</a>
                                <form action="{{ route('mahasiswa.prodi.destroy', $prodi['id_prodi']) }}" method="POST" class="d-inline">
                                    @csrf

...
@section('content')
    <div class="mb-3">
        <a href="{{ route('mahasiswa.mahasiswa.create') }}" class="btn btn-primary">
                ...
                <tbody>
                    @forelse($data as $mhs)
                        <tr>
                            ...
                            <td>{{ $mhs['no_telp'] }}</td>
                            <td>
                                <a href="{{ route('mahasiswa.mahasiswa.edit', $mhs['id_mahasiswa']) }}"
                                   class="btn btn-sm btn-warning">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <form action="{{ route('mahasiswa.mahasiswa.destroy', $mhs['id_mahasiswa']) }}"
                                      method="POST"

  ...
  <div class="card-body">
    ...
    <table class="table table-bordered">
      <tr>
        ...
        <td>{{ data_get($pengajuan, 'kategori.nama_kategori', '-') }}</td>
      </tr>
      <tr>
        <th>Status</th>
        <td>
          @php $st = data_get($pengajuan, 'status', '-'); @endphp
      ...
      <tr>
        ...
        <td>{{ \Illuminate\Support\Str::of(data_get($pengajuan, 'tgl_pengajuan', '-'))->limit(10, '') }}</td>
      </tr>
    </table>
        ...
        <tbody>
          @forelse($cplSkor as $row)
            <tr>
              ...
              <td>
                {{ data_get($row, 'cpl_master.kategori.nama_cpl', // jika relasi kategori ada
                    data_get($row, 'cpl_master.kategori', '-')    // fallback jika API kirim string
                ) }}
              </td>

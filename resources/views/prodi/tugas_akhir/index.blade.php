...
@section('content')
<div class="mb-3">
    <a href="{{ route('prodi.tugas_akhir.create') }}" class="btn btn-primary">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('prodi.tugas_akhir.edit', $item['id_tugas_akhir']) }}" class="btn btn-warning btn-sm">Edit</a>
                        <form action="{{ route('prodi.tugas_akhir.destroy', $item['id_tugas_akhir']) }}" method="POST" style="display:inline-block">
                            @csrf
                            @method('DELETE')

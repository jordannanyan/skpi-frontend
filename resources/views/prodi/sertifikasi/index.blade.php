...
@section('content')
    <div class="mb-3">
        <a href="{{ route('prodi.sertifikasi.create') }}" class="btn btn-primary">
                ...
                <tbody>
                    @forelse ($rows as $index => $sertifikasi)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('prodi.sertifikasi.edit', $sertifikasi['id_sertifikasi']) }}" class="btn btn-warning btn-sm">Edit</a>
                                <form action="{{ route('prodi.sertifikasi.destroy', $sertifikasi['id_sertifikasi']) }}"

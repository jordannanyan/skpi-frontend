...
class MahasiswaPengesahanController extends Controller
{
    private $baseUrl;
    ...
    public function index()
    {
        ...
        if ($response->successful()) {
            ...
            return view('mahasiswa.pengesahan.index', compact('data'));
        }
    ...
    public function create()
    {
        ...
        return view('mahasiswa.pengesahan.create', compact('fakultas', 'pengajuan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($response->successful()) {
            return redirect()->route('mahasiswa.pengesahan.index')->with('success', 'Data berhasil ditambahkan');
        }
    ...
    public function edit($id)
    {
        ...
        return view('mahasiswa.pengesahan.edit', compact('pengesahan', 'fakultas', 'pengajuan'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($response->successful()) {
            return redirect()->route('mahasiswa.pengesahan.index')->with('success', 'Data berhasil diperbarui');
        }
    ...
    public function destroy($id)
    {
        ...
        if ($response->successful()) {
            return redirect()->route('mahasiswa.pengesahan.index')->with('success', 'Data berhasil dihapus');
        }

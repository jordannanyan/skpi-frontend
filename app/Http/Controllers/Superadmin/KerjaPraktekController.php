...
class KerjaPraktekController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($response->successful()) {
            ...
            return view('superadmin.kerja_praktek.index', compact('data'));
        } else {
    ...
    public function create()
    {
        ...
        return view('superadmin.kerja_praktek.create', compact('mahasiswa'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($response->successful()) {
                return redirect()->route('superadmin.kerja_praktek.index')->with('success', 'Data kerja praktek berhasil ditambahkan');
            } else {
    ...
    public function edit($id)
    {
        ...
        if ($response->successful()) {
            ...
            return view('superadmin.kerja_praktek.edit', compact('kerja_praktek', 'mahasiswa'));
        } else {
            return back()->withErrors(['error' => 'Gagal mengambil data kerja praktek']);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($response->successful()) {
                return redirect()->route('superadmin.kerja_praktek.index')->with('success', 'Data kerja praktek berhasil diperbarui');
            } else {
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            if ($response->successful()) {
                return redirect()->route('superadmin.kerja_praktek.index')->with('success', 'Data kerja praktek berhasil dihapus');
            } else {

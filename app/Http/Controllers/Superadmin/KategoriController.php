...
class KategoriController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return $response->successful()
            ? redirect()->route('superadmin.kategori.index')->with('success', 'Kategori berhasil ditambahkan.')
    ...
    public function update(Request $request, $id)
    {
        ...
        return $response->successful()
            ? redirect()->route('superadmin.kategori.index')->with('success', 'Kategori berhasil diperbarui.')
    ...
    public function destroy($id)
    {
        ...
        return $response->successful()
            ? redirect()->route('superadmin.kategori.index')->with('success', 'Kategori berhasil dihapus.')

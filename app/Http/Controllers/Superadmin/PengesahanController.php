...
class PengesahanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($response->successful()) {
            return redirect()->route('superadmin.pengesahan.index')->with('success', 'Data berhasil ditambahkan');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($response->successful()) {
            return redirect()->route('superadmin.pengesahan.index')->with('success', 'Data berhasil diperbarui');
        }
    ...
    public function destroy($id)
    {
        ...
        if ($response->successful()) {
            return redirect()->route('superadmin.pengesahan.index')->with('success', 'Data berhasil dihapus');
        }

...
class SertifikasiController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            if ($response->successful()) {
                ...
                return view('superadmin.sertifikasi.index', compact('data'));
            }
    ...
    public function create()
    {
        try {
            ...
            return view('superadmin.sertifikasi.create', compact('mahasiswa'));
        } catch (\Exception $e) {
            return back()->with('error', $e->getMessage());
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($response->successful()) {
                return redirect()->route('superadmin.sertifikasi.index')->with('success', 'Sertifikasi berhasil ditambahkan');
            }
    ...
    public function edit($id)
    {
        try {
            ...
            $mahasiswa = Http::get("{$this->baseUrl}/mahasiswa")->json('data');
            return view('superadmin.sertifikasi.edit', compact('sertifikasi', 'mahasiswa'));
        } catch (\Exception $e) {
            return back()->with('error', $e->getMessage());
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($response->successful()) {
                return redirect()->route('superadmin.sertifikasi.index')->with('success', 'Sertifikasi berhasil diperbarui');
            }
    ...
    public function destroy($id)
    {
        try {
            ...
            if ($response->successful()) {
                return redirect()->route('superadmin.sertifikasi.index')->with('success', 'Sertifikasi berhasil dihapus');
            }

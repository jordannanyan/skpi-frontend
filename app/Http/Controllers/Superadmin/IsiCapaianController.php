...
class IsiCapaianController extends Controller
{
    private $baseUrl;
    ...
    public function index()
    {
        ...
        return view('superadmin.isi_capaian.index', compact('data'));
    }
    ...
    public function create()
    {
        ...
        return view('superadmin.isi_capaian.create', compact('cplSkorList'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return $response->successful()
            ? redirect()->route('superadmin.isi_capaian.index')->with('success', 'Isi Capaian berhasil ditambahkan')
    ...
    public function edit($id)
    {
        ...
        if ($response->successful()) {
            ...
            return view('superadmin.isi_capaian.edit', compact('isiCapaian', 'cplSkorList'));
        } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        return $response->successful()
            ? redirect()->route('superadmin.isi_capaian.index')->with('success', 'Isi Capaian berhasil diperbarui')
    ...
    public function destroy($id)
    {
        ...
        return $response->successful()
            ? redirect()->route('superadmin.isi_capaian.index')->with('success', 'Data berhasil dihapus')

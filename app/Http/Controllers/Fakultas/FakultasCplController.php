...
class FakultasCplController extends Controller
{
    private $baseUrl;
    ...
    public function index()
    {
        ...
        if ($response->successful()) {
            ...
            return view('fakultas.cpl.index', compact('data'));
        }
    ...
    {
        return view('fakultas.cpl.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($response->successful()) {
            return redirect()->route('fakultas.cpl.index')->with('success', 'CPL berhasil ditambahkan');
        }
    ...
    public function edit($id)
    {
        ...
        if ($response->successful()) {
            ...
            return view('fakultas.cpl.edit', compact('cpl'));
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($response->successful()) {
            return redirect()->route('fakultas.cpl.index')->with('success', 'CPL berhasil diperbarui');
        }
    ...
    public function destroy($id)
    {
        ...
        if ($response->successful()) {
            return redirect()->route('fakultas.cpl.index')->with('success', 'CPL berhasil dihapus');
        }

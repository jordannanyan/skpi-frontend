...
class ProdiKategoriController extends Controller
{
    private $baseUrl;
    ...
    public function index()
    {
        ...
        if ($response->successful()) {
            ...
            return view('prodi.kategori.index', compact('data'));
        }
    ...
    {
        return view('prodi.kategori.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return $response->successful()
            ? redirect()->route('prodi.kategori.index')->with('success', 'Kategori berhasil ditambahkan.')
    ...
    public function edit($id)
    {
        ...
        if ($response->successful()) {
            ...
            return view('prodi.kategori.edit', compact('kategori'));
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        return $response->successful()
            ? redirect()->route('prodi.kategori.index')->with('success', 'Kategori berhasil diperbarui.')
    ...
    public function destroy($id)
    {
        ...
        return $response->successful()
            ? redirect()->route('prodi.kategori.index')->with('success', 'Kategori berhasil dihapus.')

...
class ProdiCplController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($response->successful()) {
            ...
            return view('prodi.cpl.index', compact('data'));
        }
    ...
    public function store(Request $request)
    {
        ...
        if ($response->successful()) {
            return redirect()->route('prodi.cpl.index')->with('success', 'CPL berhasil ditambahkan');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($response->successful()) {
            return redirect()->route('prodi.cpl.index')->with('success', 'CPL berhasil diperbarui');
        }
    ...
    public function destroy($id)
    {
        ...
        if ($response->successful()) {
            return redirect()->route('prodi.cpl.index')->with('success', 'CPL berhasil dihapus');
        }

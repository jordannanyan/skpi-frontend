...
class ProdiPengesahanController extends Controller
{
    private $baseUrl;
    ...
    public function index()
    {
        ...
        if ($response->successful()) {
            ...
            return view('prodi.pengesahan.index', compact('data'));
        }
    ...
    public function create()
    {
        ...
        return view('prodi.pengesahan.create', compact('fakultas', 'pengajuan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($response->successful()) {
            return redirect()->route('prodi.pengesahan.index')->with('success', 'Data berhasil ditambahkan');
        }
    ...
    public function edit($id)
    {
        ...
        return view('prodi.pengesahan.edit', compact('pengesahan', 'fakultas', 'pengajuan'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($response->successful()) {
            return redirect()->route('prodi.pengesahan.index')->with('success', 'Data berhasil diperbarui');
        }
    ...
    public function destroy($id)
    {
        ...
        if ($response->successful()) {
            return redirect()->route('prodi.pengesahan.index')->with('success', 'Data berhasil dihapus');
        }
